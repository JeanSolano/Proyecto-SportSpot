  ...
  return (
    <div className="auth-wrap">
      <div className="auth-hero">
        ...
        <ul>
          <li><Trophy className="lucide" /> Fútbol, basketball, pádel, tenis y más</li>
          <li><Clock className="lucide" /> Horarios individuales por cancha</li>
          <li><Bell className="lucide" /> Reservas y notificaciones en tiempo real</li>
        </ul>
      </div>
          ...
          <form onSubmit={submit}>
            ...
            <div className="field">
              ...
              <div className="input-icon">
                ...
                <input className="input" type="email" autoComplete="email" placeholder="dueno@establecimiento.com" value={form.email} onChange={set('email')} required />
              </div>
            </div>
            <div className="field">
            ...
            <div className="field">
              ...
              <div className="input-icon">
                ...
                <input className="input" type="password" autoComplete="new-password" placeholder="••••••••" value={form.password} onChange={set('password')} required />
              </div>
              <div className="hint" style={{ color: passwordOk ? 'var(--primary-dark)' : undefined }}>
            ...
            <div className="field">
              ...
              <div className="hint" style={{ color: matchOk ? 'var(--primary-dark)' : undefined }}>
                {matchOk ? '✓ Las contraseñas coinciden' : '• Las contraseñas deben coincidir'}
              </div>
            </div>
            <button className="btn btn-primary btn-block btn-lg" disabled={loading || !valid}>
